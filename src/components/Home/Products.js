    ...
    <div className='max-w-screen-2x1 mx-auto grid grid-cols-4 gap-10 px-4'>
      {
        productData.map((item)=>(
          ...
          <div className='w-full h-auto flex items-center justify-center relative group'>
            ...
            <ul className='w-full h-36 bg-gray-100 absolute bottom-[-170px] flex flex-col items-end justify-center gap-2 fonnt-titleFont px-2 border-l border-r group-hover:bottom-0 duration-700'>
            <li className='productli'>Compare <span><CompareArrowsIcon/> </span></li>
